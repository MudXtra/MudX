...
{
    public static class CodeBlockCopyExampleCode
    {
        public static readonly IEnumerable<CodeFile> Files = new[]
        {
            new CodeFile
            (
                Title: "CodeBlockCopyExample.razor",
