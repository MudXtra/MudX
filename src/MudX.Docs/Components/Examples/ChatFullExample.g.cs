...
{
    public static class ChatFullExampleCode
    {
        public static readonly IEnumerable<CodeFile> Files = new[]
        {
            new CodeFile
            (
                Title: "ChatFullExample.razor",
